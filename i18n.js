...
export const I18N = {
  [LANG.HI]: {
    ...
    mic_permission_denied: "माइक्रोफ़ोन अनुमति बंद है। कृपया ब्राउज़र/साइट सेटिंग में अनुमति चालू करें।",
  ...
  [LANG.HINGLISH]: {
    ...
    mic_permission_denied: "Microphone permission blocked hai. Kripya browser/site settings mein permission on karein.",
  ...
  [LANG.EN]: {
    ...
    mic_permission_denied: "Microphone access is blocked. Please enable it in your browser/site settings.",
