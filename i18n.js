...
export const I18N = {
  [LANG.HI]: {
    ...
    mic_permission_prompt: "बोलकर टाइप करने के लिए माइक्रोफ़ोन की अनुमति (Allow) दें।",
    mic_permission_denied: "माइक्रोफ़ोन अनुमति अस्वीकार की गई है। कृपया साइट सेटिंग में जाकर माइक्रोफ़ोन अनुमति चालू करें या किसी की मदद लें।",
  ...
  [LANG.HINGLISH]: {
    ...
    mic_permission_prompt: "Bolkar type karne ke liye kripya microphone permission allow karein.",
    mic_permission_denied: "Microphone permission deny ho chuki hai. Kripya site settings mein jaakar microphone permission allow karein, ya kisi se madad lein.",
  ...
  [LANG.EN]: {
    ...
    mic_permission_title: "Microphone permission",
    mic_permission_prompt: "Please allow microphone access to use speech typing.",
    mic_permission_denied: "Microphone permission is denied. Please go to site settings and allow microphone access, or take someone's help.",
