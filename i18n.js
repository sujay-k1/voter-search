...
export const I18N = {
  [LANG.HI]: {
    ...
    banner_important: "महत्वपूर्ण सूचना:",
    banner_text: "हर खोज परिणाम में पेज नंबर, सीरियल नंबर और संबंधित PDF फ़ाइल दिखाई जाती है। कृपया अपनी जानकारी मिलान करके देखें।",
    know_more: "और जानें",
    go_back: "वापस जाएँ",
    announce_roll_title: "झारखंड मतदाता सूची - 2003",
    announce_title: "पोर्टल के बारे में, यह क्यों बना, और इसे कैसे इस्तेमाल करें!",
    announce_intro:
      "इस पोर्टल से झारखंड की 2003 SIR सूची में अपनी प्रविष्टि जल्दी खोजें। संभावित मिलान मिलने पर मूल PDF में अवश्य पुष्टि करें।",
    announce_about_heading: "इसके बारे में थोड़ा:",
    announce_about_text:
      "यह पोर्टल आपको 2003 Special Intensive Revision (SIR) मतदाता सूची में अपना नाम खोजने और आम समस्याएँ जैसे उम्र, नाम की वर्तनी, संबंध का प्रकार और रिश्तेदार के नाम में असंगति पहचानने में मदद करता है।",
    announce_need_heading: "इसकी ज़रूरत क्यों पड़ी?",
    announce_need_ceo: "CEO Jharkhand भाग-वार PDF डाउनलोड देता है (कई रीडर में भरोसेमंद टेक्स्ट सर्च नहीं मिलता)।",
    announce_link_ceo: "https://ceojh.jharkhand.gov.in/mrollpdf1/aceng.aspx",
    announce_need_eci:
      "ECI का Search in SIR टूल कुछ गलत वर्तनियाँ संभाल लेता है, लेकिन सभी OCR/टाइपिंग त्रुटियाँ नहीं।",
    announce_link_eci: "https://voters.eci.gov.in/searchInSIR/S2UA4DPDF-JK4QW0DSE",
    announce_tips_heading: "इसे बेहतर तरीके से उपयोग करने के लिए खोज सुझाव:",
    announce_tip_1: "अगर आपका नाम न मिले, तो अपने रिश्तेदार का नाम (जैसा वोटर ID में है) से खोजें।",
    announce_tip_2:
      "अगर 2003 का अपना निर्वाचन क्षेत्र/पार्ट निश्चित न हो, तो पहले पूरे जिले में खोजें, फिर सही AC/पार्ट तक सीमित करें।",
    announce_tip_3:
      "करीब-करीब मिलती वर्तनी से शुरुआत करें, फिर उम्र सीमा (2003 के अनुसार), लिंग और रिश्तेदार के नाम से परिणाम संकुचित करें।",
    announce_note_heading: "महत्वपूर्ण सूचना:",
    announce_note_text:
      "इन सूचियों का डिजिटलीकरण OCR से किया गया है, इसलिए मशीन-पठनीय टेक्स्ट स्कैन की गई PDF से अलग हो सकता है। कोई भी कार्रवाई करने से पहले PDF प्रविष्टि से मिलान अवश्य करें।",
